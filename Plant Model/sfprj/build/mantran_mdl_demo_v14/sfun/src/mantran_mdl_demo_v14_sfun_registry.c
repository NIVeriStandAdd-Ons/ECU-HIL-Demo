...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_mantran_mdl_demo_v14_process_check_sum_call( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_mantran_mdl_demo_v14_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
{
  extern unsigned int sf_mantran_mdl_demo_v14_autoinheritance_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_mantran_mdl_demo_v14_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
{
  extern unsigned int sf_mantran_mdl_demo_v14_get_eml_resolved_functions_info(
  ...
  if(strcmp(machineName, "mantran_mdl_demo_v14") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return
    sf_mantran_mdl_demo_v14_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_mantran_mdl_demo_v14_method_dispatcher(SimStruct *S,
...
{
  if(!strcmp(machineName,"mantran_mdl_demo_v14")) {
    return(sf_mantran_mdl_demo_v14_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  return 0;
}
extern void mantran_mdl_demo_v14_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    mantran_mdl_demo_v14_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void mantran_mdl_demo_v14_initializer(void);
extern void mantran_mdl_demo_v14_register_exported_symbols(SimStruct* S);
extern void mantran_mdl_demo_v14_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  mantran_mdl_demo_v14_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      mantran_mdl_demo_v14_debug_initialize();
    }
    mantran_mdl_demo_v14_initializer();
  }
  return;
}
