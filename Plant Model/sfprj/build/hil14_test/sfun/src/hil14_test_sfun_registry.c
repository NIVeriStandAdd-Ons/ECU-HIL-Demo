...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_hil14_test_process_check_sum_call( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_hil14_mdl_lib_process_check_sum_call( int nlhs, mxArray
   * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_hil14_test_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  if(sf_hil14_mdl_lib_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_autoinheritence_call( int nlhs, mxArray * plhs[], int
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_hil14_test_autoinheritance_info( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_hil14_test_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray
 * plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_hil14_test_get_eml_resolved_functions_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_hil14_mdl_lib_get_eml_resolved_functions_info( int
  ...
  if(strcmp(machineName, "hil14_test") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_hil14_test_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
  if(strcmp(machineName, "hil14_mdl_lib") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_hil14_mdl_lib_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_hil14_test_method_dispatcher(SimStruct *S, unsigned int
 chartFileNumber, int_T method, void *data);
extern unsigned int sf_hil14_mdl_lib_method_dispatcher(SimStruct *S, unsigned
...
{
  if(!strcmp(machineName,"hil14_test")) {
    return(sf_hil14_test_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  if(!strcmp(machineName,"hil14_mdl_lib")) {
    return(sf_hil14_mdl_lib_method_dispatcher(simstructPtr,chartFileNumber,method,data));
  }
  return 0;
}
extern void hil14_test_terminator(void);
extern void hil14_mdl_lib_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    hil14_test_terminator();
    hil14_mdl_lib_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void hil14_test_initializer(void);
extern void hil14_mdl_lib_initializer(void);
extern void hil14_test_register_exported_symbols(SimStruct* S);
extern void hil14_mdl_lib_register_exported_symbols(SimStruct* S);
extern void hil14_test_debug_initialize(void);
extern void hil14_mdl_lib_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  hil14_test_register_exported_symbols(S);
  hil14_mdl_lib_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      hil14_test_debug_initialize();
    }
    hil14_test_initializer();
    if(!simModeIsRTWGen) {
      hil14_mdl_lib_debug_initialize();
    }
    hil14_mdl_lib_initializer();
  }
  return;
}
